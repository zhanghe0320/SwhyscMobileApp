class Api {
  ...
  static const String BASE_URL = 'http://192.168.2.229:8082/wx';
  ...
  static const String HOME_FIRST_CATEGORY=BASE_URL+'/catalog/getfirstcategory';//理财展业分类第一级
  static const String HOME_SECOND_CATEGORY=BASE_URL+'/catalog/getsecondcategory';//理财展业分类第二级
  static const String GOODS_TOTAL_NUMBER=BASE_URL+'/goods/count';//获取商品总数
  static const String GOODS_CATEGORY_URL=BASE_URL+'/goods/category/list';//理财下的产品分类
  static const String GOODS_LIST_URL=BASE_URL+'/goods/list';//理财下的产品列表
  static const String GOODS_DETAILS_URL=BASE_URL+'/goods/detail';//产品详情
