...
import 'package:mall/page/home/market.dart';
import '../main.dart';
    ...
    return new Card(
      ...
      child: new ListTile(
        ...
        leading: snapshot["quantity"] >= 0
            ? new Icon(Icons.add_circle, color: Colors.red, size: 28.0)
            : new Icon(Icons.remove_circle, color: Colors.green, size: 28.0),
        title: new RichText(
          ...
          TextSpan(
              ...
              style: Theme.of(context)
                  .textTheme
                  .body2
                  .apply(color: changePercent > 0 ? Colors.red : Colors.green)),
        ])),
        subtitle: new Text(
